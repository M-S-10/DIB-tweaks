...
pinMode(d2_dir, OUTPUT);
  ...
  d1_step_motor.setMaxSpeed(1800.0);
  d1_step_motor.setAcceleration(200.0);
  d2_step_motor.setMaxSpeed(1800.0);
...
bool d1_close = false;
  ...
  d1_step_motor.setSpeed(-275);
  d2_step_motor.setSpeed(-300);
//digitalWrite(d1_ena,HIGH);
//digitalWrite(d2_ena,HIGH);
...
void initiate_door_opening()
{
  ...
  //digitalWrite(d1_ena,HIGH);
//digitalWrite(d2_ena,HIGH);
  d1_step_motor.setSpeed(200);
  d2_step_motor.setSpeed(170);
